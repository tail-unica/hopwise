...
from hopwise.data.dataset.kg_dataset import KnowledgeBasedDataset, UserItemKnowledgeBasedDataset
...
from hopwise.data.dataset.kg_path_dataset import KnowledgePathDataset, UserItemKnowledgePathDataset
