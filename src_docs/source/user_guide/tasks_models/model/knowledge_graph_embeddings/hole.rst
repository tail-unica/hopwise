...
`[paper] <https://ojs.aaai.org/index.php/AAAI/article/view/10314>`_

**Title:** Holographic Embeddings of Knowledge Graphs

**Authors:** Maximilian Nickel, Lorenzo Rosasco, Tomaso Poggio

**Abstract:** HolE (Holographic Embeddings) uses circular correlation to create compositional
representations of knowledge graph triplets. It combines the expressive power of tensor
factorization with the efficiency of embedding models, achieving competitive performance
