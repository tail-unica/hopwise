...
Note that for Knowledge-based models, we add one more relation called ``U-I Relation``. It describes the history interactions which will be used in :meth:`hopwise.data.dataset.kg_dataset.KnowledgeBasedDataset.ckg_graph`.
