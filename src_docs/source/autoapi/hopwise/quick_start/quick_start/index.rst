...
.. py:module:: hopwise.quick_start.quick_start
...
.. autoapisummary::
   ...
   hopwise.quick_start.quick_start.run
   hopwise.quick_start.quick_start.run_hopwise
   hopwise.quick_start.quick_start.get_logger
   hopwise.quick_start.quick_start.format_metrics
   hopwise.quick_start.quick_start.run_hopwises
   hopwise.quick_start.quick_start.objective_function
   hopwise.quick_start.quick_start.load_data_and_model
...
.. py:function:: get_logger(config)

.. py:function:: format_metrics(metrics)
