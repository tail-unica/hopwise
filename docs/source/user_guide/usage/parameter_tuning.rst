...
:attr:`algo` is the optimization algorithm. hopwise support three tunning methods:
...
:class:`~hopwise.trainer.hyper_tuning.HyperTuning` supports four range types,
...
.. code:: yaml
    ...
    dataset: ml-100k
    model: BPR
    data_path: /home/user/hopwise/dataset
...
.. code:: bash
   ...
   == Status ==
    ...
    Result logdir: /home/wangzhenlei/wanglei/dev-bole/hopwise/ray_log/objective_function_2022-07-23_22-31-06
