...
.. toctree::
   ...
   model/knowledge_aware/cke
   model/knowledge_aware/cfkg
   model/knowledge_aware/ktup
   model/knowledge_aware/kgat
   model/knowledge_aware/kgin
   model/knowledge_aware/ripplenet
   model/knowledge_aware/mcclk
   model/knowledge_aware/mkr
