...
**Hopwise uses the same data flow as RecBole.**
...
- DataLoader:
    Mainly based on a general internal data structure implemented by our library, called :class:`~hopwise.data.interaction.Interaction`.
    :class:`~hopwise.data.interaction.Interaction` is the internal data structural that is fed into the recommendation algorithms.
