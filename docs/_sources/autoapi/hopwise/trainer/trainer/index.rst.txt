...
.. py:module:: hopwise.trainer.trainer
...
.. autoapisummary::
   ...
   hopwise.trainer.trainer.grad_scaler
...
.. autoapisummary::
   ...
   hopwise.trainer.trainer.AbstractTrainer
   hopwise.trainer.trainer.Trainer
   hopwise.trainer.trainer.KGTrainer
   hopwise.trainer.trainer.ExplainableTrainer
   hopwise.trainer.trainer.PGPRTrainer
   hopwise.trainer.trainer.CAFETrainer
   hopwise.trainer.trainer.KGATTrainer
   hopwise.trainer.trainer.PretrainTrainer
   hopwise.trainer.trainer.S3RecTrainer
   hopwise.trainer.trainer.TPRecTrainer
   hopwise.trainer.trainer.MKRTrainer
   hopwise.trainer.trainer.TraditionalTrainer
   hopwise.trainer.trainer.DecisionTreeTrainer
   hopwise.trainer.trainer.XGBoostTrainer
   hopwise.trainer.trainer.LightGBMTrainer
   hopwise.trainer.trainer.RaCTTrainer
   hopwise.trainer.trainer.RecVAETrainer
   hopwise.trainer.trainer.NCLTrainer
   hopwise.trainer.trainer.PEARLMfromscratchTrainer
   hopwise.trainer.trainer.HFPathLanguageModelingTrainer
   hopwise.trainer.trainer.KGGLMTrainer
...
.. py:class:: AbstractTrainer(config, model)
   ...
   .. py:method:: set_reduce_hook()

      Call the forward function of 'distributed_model' to apply grads
      reduce hook to each parameter of its module.




   .. py:method:: sync_grad_loss()

      Ensure that each parameter appears to the loss function to
...
.. py:class:: ExplainableTrainer(config, model)
   ...
   .. py:method:: _full_sort_batch_eval(batched_data, tot_item_num, item_tensor, **kwargs)


.. py:class:: PGPRTrainer(config, model)

   Bases: :py:obj:`ExplainableTrainer`


   PGPRTrainer is designed for PGPR, which is a knowledge-aware recommendation method.


.. py:class:: CAFETrainer(config, model)

   Bases: :py:obj:`ExplainableTrainer`


   CAFETrainer is designed for CAFE, which is a knowledge-aware recommendation method.
...
.. py:class:: PretrainTrainer(config, model)

   Bases: :py:obj:`Trainer`


   PretrainTrainer is designed for pre-training.
   It can be inherited by the trainer which needs pre-training and fine-tuning.


   .. py:attribute:: pretrain_epochs


   .. py:attribute:: save_step


   .. py:method:: save_pretrained_model(epoch, saved_model_file)

      Store the model parameters information and training information.

      :param epoch: the current epoch id
      :type epoch: int
      :param saved_model_file: file name for saved pretrained model
      :type saved_model_file: str
